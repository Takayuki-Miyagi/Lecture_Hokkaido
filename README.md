# 集中講義「原子核の第一原理計算：核力から原子核へ」
* Lecture  1: 原子核の第一原理計算の意義．基本的な事項（第二量子化など）
* Lecture  2: One-pion exchange modelによる核力
* Lecture  3: Chiral effective field theoryによる核力
* Lecture  4: 核力の繰込と行列要素の計算
* Lecture  5: Hands-on session: 核子-核子散乱を解いてみよう
* Lecture  6: 量子多体問題 I（厳密対角化の限界，正規順序積，平均場近似)
* Lecture  7: 量子多体問題 II (多体摂動論，媒質中における相似繰込群法)
* Lecture  8: Hands-on session: Hartree-Fock法と多体摂動論による数値計算
* Lecture  9: 電弱過程
